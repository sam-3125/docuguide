...
export default function HomePanel() {
  ...
  const detailedFeatures = [
    ...
    {
      icon: <MagnifyingGlass size={32} className="text-purple-500" />,
  ...
  return (
    // Outer container: Fixed, full screen, and handles its own scrolling
    <div className="fixed inset-0 w-screen h-screen overflow-y-auto scrollbar-hide bg-gradient-to-br from-[#f7f9ff] via-[#f4f7ff] to-white dark:from-theme-bg-container dark:via-theme-bg-primary dark:to-theme-bg-container relative">
      ...
      <motion.section
        ...
        // Removed custom style for centering, mx-auto handles it effectively within w-full max-w-4xl
